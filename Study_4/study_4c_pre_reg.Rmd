...
dt_pro_choice <- read_csv('Data/s4c_pro_choice.csv') |> 
  mutate(stance = "pro_choice")

dt_pro_life <- read_csv('Data/s4c_pro_life.csv') |> 
...
#add NLP measures
s4c_nlp <- read_csv("NLP_data/study_4c_nlp.csv")

dt_analysis_nlp <- dt_analysis |> 
  left_join(s4c_nlp, by = "ResponseId")
